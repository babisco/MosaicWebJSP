...
<%
	...
	if (login == null) {
		response.sendRedirect("/session2/loginForm.jsp");
		return;
	}
%>
...
<%
	...
	mapper.insert(new Dept(65,"ACCOUNTING2", "SEOUL"));
	...
	System.out.println("=========================");
	out.println("<hr>");
	mapper.update(new Dept(65,"ACCOUNTING3", "BUSAN"));
...
<a href="/session2/logout.jsp">로그아웃</a>
</body>
</html>